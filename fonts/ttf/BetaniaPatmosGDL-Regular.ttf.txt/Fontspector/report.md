...
<details><summary>[16] BetaniaPatmosGDL-Regular.ttf</summary>
<div>
...
| U+1E80: LATIN CAPITAL LETTER W WITH GRAVE      | U+1E81: LATIN SMALL LETTER W WITH GRAVE      | [code: missing-case-counterparts]
...
- 🔥 **FAIL** "Betania Patmos GDL" contains an abbreviation. [code: abbreviation]
...
* Uacute (U+00DA): found 5, expected one of: {6, 3, 2}
* Ugrave (U+00D9): found 5, expected one of: {3, 2, 6}
* Utilde (U+0168): found 5, expected one of: {3, 6, 2}
* V (U+0056): found 4, expected one of: {5, 1, 2}
* uniA78B (U+A78B): found 4, expected one of: {1}
* c (U+0063): found 4, expected one of: {3, 5, 1}
* ccedilla (U+00E7): found 5, expected one of: {2, 1, 6}
* dotlessi (U+0131): found 4, expected one of: {1, 2}
...
- ℹ️ **INFO** Hinting filesize impact:
 ...
 |               | BetaniaPatmosGDL-Regular.ttf     |
 |:------------- | ---------------:|
 | Dehinted Size | 176988 |
 | Hinted Size   | 301496   |
 | Increase      | 124508      |
 | Change        | 70.3 %  | [code: size-impact]
...
- 🔥 **FAIL** BetaniaPatmosGDL-Regular.ttf missing required codepoints:
...
* U+0307 COMBINING DOT ABOVE: try adding one of: malayalam, tai-le, tifinagh, canadian-aboriginal, duployan, math, old-permic, hebrew, coptic, syriac, todhri
